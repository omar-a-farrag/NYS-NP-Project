...
\begin{table}[htbp]
\centering
\caption{Full Sample Unique NYS Provider Count: Inpatient By Authority and Provider Type}
\label{tab:inpatient_auth_x_provtype_full}
\begin{threeparttable}
\begin{tabular}{lccc}
\toprule
\textbf{State NP Authority} & \textbf{MD/DO} & \textbf{Nurse Practitioner} & \textbf{Physician Assistant} \\
\midrule
        Full Practice & 111,408 & 15,700 & 12,869 \\
\bottomrule
\end{tabular}
