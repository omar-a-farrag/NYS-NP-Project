...
* PURPOSE: Binscatters mapping Provider Behavior vs Provider MIPS (Both Directions)
...
* --- START LOG ---
local script_name "08a_provider_quality_curves"
...
foreach setting in "in_patient" "out_patient" {
    display "=== STARTING QUALITY CURVES FOR: `setting' PROVIDERS ==="
    ...
    * --- 4. PRE-GENERATE LAGS & LEADS (xtset Safe) ---
