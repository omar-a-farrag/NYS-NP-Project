...
foreach var in `dep_vars' {
    ...
    *--------------------------------------------------
    ...
    local data_note "Data: CMS Outpatient Ambulatory (2015-2023) | N = `n_fmt' provider-year observations."
    ...
    *--------------------------------------------------
    ...
    esttab . using "$outRoot/out_patient/tables/`var'_by_provtype.tex", replace ///
    ...
    esttab . using "$outRoot/out_patient/tables/`var'_by_auth_provtype.tex", replace ///
