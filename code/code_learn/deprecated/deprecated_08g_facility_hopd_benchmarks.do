...
* FEATURES: HCAHPS Groups 1-4, Dynamic Clean Titles, YOY Lags
*===============================================================================
...
* --- 4. GRAPHING ENGINE ---
display "4. Generating Journal-Ready HOPD Visualizations..."
local baseOut "$outRoot/out_patient/benchmarks_hopd_facility"
...
* Include only the core HOPD metrics and ED metrics
    ...
    if _rc == 0 {
        ...
        * --- TITLE DICTIONARY ---
        if "`var'" == "hopd_op_8" {
            ...
            local v_note "Outpatient Outcome (OP-8): Rate of MRI Lumbar Spine for Low Back Pain (Efficiency metric)."
        }
            ...
            local c_title "Post-Colonoscopy Hospital Visit Rate"
            local v_note "Outpatient Outcome (OP-32): 7-Day Risk-Standardized Hospital Visit Rate after Outpatient Colonoscopy."
        }
        else if "`var'" == "hopd_op_36" {
            local c_title "Post-Outpatient Surgery Visit Rate"
