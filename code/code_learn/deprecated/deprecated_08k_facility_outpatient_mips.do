...
* FEATURES: Market-Proxy Merging, Clean Titles, Strict Formatting, Memory Safe
*===============================================================================
...
* Collapse Behaviors, Labor Supply, AND the 5 MIPS metrics to the ZIP level
collapse (sum) count_* ///
...
* --- 6. GRAPHING ENGINE ---
display "5. Generating Journal-Ready MIPS ASC Visualizations..."
local baseOut "$outRoot/out_patient/benchmarks_mips_facility"
...
foreach var in `outcome_vars' {
    ...
    if _rc == 0 {
        ...
        * MEMORY FIX: Flush Stata's graph memory to prevent crashing
