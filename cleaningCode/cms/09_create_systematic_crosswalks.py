...
# Dynamically scan ALL available years of Part D data to generate empirical costs
print("  Detecting available years in harmonized data...")
files = glob.glob(os.path.join(partd_dir, "partd_*_harmonized.dta"))
files.sort()

if not files:
    print("  CRITICAL ERROR: No harmonized Part D files found. Check your paths.")
    import sys
    sys.exit(1)
